...
public class Freeze implements CommandExecutor{
    ...
    public static ArrayList<Player> ss_players = new ArrayList<Player>();
            ...
            if(p.hasPermission("staffmode.freeze")) {
                if(args.length == 1) {
                    ...
                    if(t != null) {
                        ...
                        }else if(ss_players.contains(t)) {
                            p.sendMessage(ChatColor.translateAlternateColorCodes('&', messages.getString("Freeze.already_frozen")));
                        }
                    }else {
                ...
                if(args.length == 0 ||args.length >= 2) {
                    p.sendMessage(ChatColor.translateAlternateColorCodes('&', messages.getString("CorrectUsages.freeze")));
                    return true;
                }
            }else {
